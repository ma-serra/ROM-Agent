...
const MODELS = {
  ...
  sonnet: {
    id: 'us.anthropic.claude-haiku-4-5-20251001-v1:0',  // FIX: Sonnet legacy bloqueado, usando Haiku 4.5
    name: 'Claude Haiku 4.5',
    maxTokens: 8000,  // REAL LIMIT: 8,192 output tokens
    costPer1M: { input: 1.0, output: 5.0 },  // Haiku mais barato
    purpose: 'analysis',
    speed: 'fast'  // Haiku é mais rápido
  },
  opus: {
